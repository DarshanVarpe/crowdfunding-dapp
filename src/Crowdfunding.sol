...
contract Crowdfunding {
    ...
    // --- 1. NEW: Define the structure for a single comment ---
    struct Comment {
        address author;
        uint256 timestamp;
        string commentText;
    ...
    // --- 2. NEW: Create an array to store all comments for this campaign ---
    ...
    // --- 3. NEW: Add a function to allow users to post a comment ---
    function postComment(string memory _commentText) public notPaused {
    ...
    // --- 4. NEW: Add a function to retrieve all comments ---
